...
testEx2 = mapM_ parse $ map sentence [1..10]
...
ppMode _ [] = empty
ppMode False [R] = mtab Text.PrettyPrint.<> ends
ppMode True [R] = tab
ppMode False [L] = mtab Text.PrettyPrint.<> vr
ppMode True [L] = bar
ppMode True [D] = bar
ppMode False [D] =  mtab Text.PrettyPrint.<> vr
ppMode b (L:t) = bar Text.PrettyPrint.<> ppMode b t
ppMode b (D:t) = tab Text.PrettyPrint.<> ppMode b t
ppMode b (R:t) = tab Text.PrettyPrint.<> ppMode b t

ppD (Split (m,i) Nil Nil) =
     (if m /= [] && last m == L then ppMode True m else empty)
 $+$ ppMode False m  Text.PrettyPrint.<> dot Text.PrettyPrint.<> space Text.PrettyPrint.<> ppItem_a i
 $+$ ppMode True m Text.PrettyPrint.<> space Text.PrettyPrint.<> dot'  Text.PrettyPrint.<> space Text.PrettyPrint.<> ppItem_b i
 $+$ ppMode True m

ppD (Split (m,i) l r) =
     ppMode False m Text.PrettyPrint.<> space Text.PrettyPrint.<> ppItem_a i
 $+$ ppMode True m Text.PrettyPrint.<> space Text.PrettyPrint.<> space Text.PrettyPrint.<> ppItem_b i
 $+$ ppD l
 $+$ ppD r

ppD (Extend (m,i) Nil ) =
   ppMode True m Text.PrettyPrint.<> space Text.PrettyPrint.<> ppItem_a i
-- $+$ ppMode True m Text.PrettyPrint.<> space Text.PrettyPrint.<> space Text.PrettyPrint.<> ppItem_b i
 -- $+$ ppMode True m Text.PrettyPrint.<> mtab Text.PrettyPrint.<> pipe
...
sp3 = text "  "
pipe = text "|" --[chr 9475]
ends = text "\\="  -- [chr 9495] Text.PrettyPrint.<> line  -- text "\\"
bar = mtab Text.PrettyPrint.<> pipe
