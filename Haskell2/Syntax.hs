...
-- The CorrespondeningTypes type class defines the relation beteen
...
{- SynCat : Syntactic Categories, uniform container for syntactic types -}
data SynCat
  = WNP
  | WN
  | WS
